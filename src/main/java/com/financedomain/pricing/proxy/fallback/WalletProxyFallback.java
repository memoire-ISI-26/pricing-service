...
public class WalletProxyFallback implements WalletProxy {
    ...
    @Override
    public ResponseEntity<TransactionDto> purchase(WalletPurchaseRequest request, String xUserPhone, String xUserRole) {
        ...
        throw new RuntimeException("Le service de paiement (wallet-service) est indisponible. Votre achat n'a pas pu être validé.");
    }
}
